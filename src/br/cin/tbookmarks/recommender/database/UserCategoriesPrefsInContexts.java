...
public class UserCategoriesPrefsInContexts {
	...
	private static HashMap<Long,HashMap<ContextualCriteria,HashMap<ItemCategory,Integer>>> userPrefsWithGoodRatingsOnly;
	
	private UserCategoriesPrefsInContexts() {
		userPrefs = new HashMap<Long, HashMap<ContextualCriteria,HashMap<ItemCategory,Integer>>>();
		userPrefsWithGoodRatingsOnly = new HashMap<Long, HashMap<ContextualCriteria,HashMap<ItemCategory,Integer>>>();
	}
	...
	public HashMap<Long, HashMap<ContextualCriteria, HashMap<ItemCategory, Integer>>> getUserPrefsWithGoodRatingsOnly() {
		return userPrefsWithGoodRatingsOnly;
	}
	
	public void setUserPrefsWithGoodRatingsOnlyToUser(Long userID, HashMap<ContextualCriteria, HashMap<ItemCategory, Integer>> preferences){
